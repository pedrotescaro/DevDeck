    ...
    >
      <div className="flex items-start justify-between gap-5">
        <div className="min-w-0 pt-1">
          <span className="inline-flex rounded-lg bg-dd-muted px-3 py-2 text-[10px] font-black uppercase leading-4 tracking-wide text-white">
            Ritmo DevDeck
          </span>
      ...
      <div className="mt-5 rounded-2xl bg-dd-surface p-3.5">
        <div className="grid grid-cols-7 gap-1.5" aria-label="Atividade semanal">
          {WEEK_DAYS.map((day) => {
