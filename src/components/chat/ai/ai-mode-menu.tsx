      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute bottom-full left-0 z-50 mb-2 w-64 origin-bottom-left overflow-hidden rounded-xl border border-dd-border/70 bg-dd-surface p-2 font-sans shadow-[0_12px_40px_rgba(0,0,0,0.4)]"
          >
            {/* Modelo */}
            <div>
              <button
