...
export default function LandingCTA({ initialUser }: LandingCTAProps) {
  ...
  return (
    <section className="relative py-32 lg:py-40 bg-[var(--lp-bg)] overflow-hidden" id="start">
      {/* Background glow */}
      ...
      <div className="mx-auto max-w-4xl px-6 relative z-10 text-center flex flex-col items-center">
        ...
        >
          <div className="flex items-center justify-between px-4 py-2 bg-[var(--lp-bg-card)] border-b border-[var(--lp-border)]">
