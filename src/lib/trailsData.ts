  ...
  JS: [
    {
      ...
      questions: [
        {
          id: "js-l1-q1",
          question: "Qual palavra-chave declara uma variável com escopo de bloco que pode ser reatribuída?",
    ...
    },
    {
      ...
      questions: [
        {
          id: "js-l3-q1",
          question: "Qual método adiciona um ou mais elementos ao final de um array e retorna o novo comprimento?",
        ...
        {
          id: "js-l3-q3",
          question: "Qual método extrai uma seção de um array e retorna um novo array sem modificar o original?",
    ...
    },
    {
      ...
      questions: [
        ...
        {
          id: "js-l4-q2",
          question: "Qual é a principal diferença de comportamento das Arrow Functions em relação à palavra-chave this?",
          options: [
        ...
        {
          id: "js-l4-q3",
          question: "Qual método de array executa uma função de callback para cada elemento, retornando um novo array com os resultados?",
    ...
    },
    {
      ...
      questions: [
        ...
        {
          id: "js-l5-q3",
          question: "Qual método executa múltiplas promises em paralelo e falha imediatamente se qualquer uma for rejeitada?",
    ...
    },
    {
      ...
      questions: [
        {
          id: "js-l6-q1",
          question: "Qual método seleciona o primeiro elemento que corresponde a um seletor CSS específico?",
          options: ["getElementById()", "getElementsByClassName()", "querySelector()", "querySelectorAll()"],
          correctIndex: 2,
        },
        {
          id: "js-l6-q2",
          question: "Qual método adiciona um ouvinte de eventos a um elemento HTML sem sobrescrever os existentes?",
          options: ["onclick = fn", "addEventListener()", "attachEvent()", "listen()"],
          correctIndex: 1,
        },
        {
          id: "js-l6-q3",
          question: "Qual API nativa do JS moderno realiza requisições HTTP assíncronas e retorna uma Promise?",
    ...
    },
    {
      ...
      questions: [
        ...
        {
          id: "js-l7-q2",
          question: "Qual tipo de referência fraca não previne que o garbage collector colete chaves de objeto?",
    ...
    },
    {
      ...
      questions: [
        {
          id: "js-l8-q1",
          question: "Qual das seguintes alternativas é uma causa comum de vazamento de memória (Memory Leak) em SPAs?",
          options: [
        ...
        {
          id: "js-l8-q2",
          question: "Como o algoritmo Mark-and-Sweep do Garbage Collector decide se um objeto deve ser limpo?",
          options: [
        ...
        {
          id: "js-l8-q3",
          question: "Qual técnica evita a execução repetida de uma função de alto custo a cada evento de scroll limitando a no máximo 1 execução por intervalo fixo?",
  ...
  TS: [
    {
      ...
      questions: [
        ...
        {
          id: "ts-l1-q2",
          question: "Qual tipo é mais seguro para variáveis de tipo desconhecido, forçando verificação antes do uso?",
        ...
        },
        {
          ...
          options: ["let x = y as string", "let x: string = y", "let x = <string>y", "Ambas as opções A e C estão corretas"],
          correctIndex: 3,
        },
      ],
    },
      ...
      questions: [
        {
          ...
          options: ["Adicionando um '?' após o nome da propriedade", "Adicionando '| null' ao tipo", "Usando a palavra-chave optional", "Adicionando '| undefined'"],
          correctIndex: 0,
        },
        {
          id: "ts-l2-q2",
    ...
    },
    {
      ...
      questions: [
        {
          id: "ts-l3-q1",
          question: "Qual operador é usado para declarar um tipo de União (Union Type) no TypeScript?",
          options: ["&", "|", "&&", "||"],
          correctIndex: 1,
        },
        {
      ...
      questions: [
        {
          ...
          options: ["function identity(arg: T): T", "function identity<T>(arg: T): T", "function <T>identity(arg: T)", "function identity(arg: <T>)"],
          correctIndex: 1,
        },
        {
          id: "ts-l4-q2",
          question: "Como restringir um tipo genérico T para herdar propriedades de outro tipo (ex: Lengthwise)?",
          options: ["<T implements Lengthwise>", "<T extends Lengthwise>", "<T: Lengthwise>", "<T typeof Lengthwise>"],
          correctIndex: 1,
        },
        {
          id: "ts-l4-q3",
    ...
    },
    {
      ...
      questions: [
        {
          id: "ts-l5-q1",
          question: "Qual utilitário constrói um tipo pegando apenas um conjunto de propriedades K de T?",
    ...
    },
    {
      ...
      questions: [
        {
          id: "ts-l6-q1",
          question: "Qual modificador de classe impede o acesso à propriedade fora da classe, exceto nas subclasses derivadas?",
          options: ["private", "protected", "public", "readonly"],
          correctIndex: 1,
        },
        {
          id: "ts-l6-q2",
          question: "Como declarar um parâmetro de construtor de classe que cria e inicializa um membro automaticamente?",
          options: [
        ...
        {
          id: "ts-l6-q3",
          question: "O que acontece ao tentar herdar uma classe que não possui construtor acessível?",
          options: [
    ...
    },
    {
      ...
      questions: [
        {
          id: "ts-l7-q1",
          question: "Qual palavra-chave é usada dentro de uma cláusula extends de um tipo condicional para inferir um tipo dinâmico?",
    ...
    },
    {
      ...
      questions: [
        {
          id: "ts-l8-q1",
          question: "Qual é o retorno correto de uma assinatura de predicado de tipo customizada (User-defined Type Guard)?",
          options: ["parameterName is Type", "boolean", "parameterName instanceof Type", "Type"],
          correctIndex: 0,
        },
        {
          id: "ts-l8-q2",
          question: "Qual operador assegura ao compilador que um valor não é null nem undefined (Non-null Assertion Operator)?",
          options: ["?", "!", "??", "as any"],
          correctIndex: 1,
        },
        {
          id: "ts-l8-q3",
          question: "Qual palavra-chave realiza estreitamento de tipo em blocos condicionais testando classes em tempo de execução?",
    ...
    },
    {
      ...
      questions: [
        ...
        {
          id: "ts-l9-q2",
          question: "Para usar decoradores experimentais, qual configuração deve estar ativada no tsconfig.json?",
          options: [
        ...
        {
          id: "ts-l9-q3",
          question: "O que o decorador de método recebe em sua assinatura além do target e propertyKey?",
          options: [
  ...
  PYTHON: [
    ...
    },
    {
      ...
      questions: [
        {
          id: "py-l2-q1",
          question: "Como escrever uma list comprehension que filtra números pares de um range(10)?",
          options: [
    ...
    },
    {
      ...
      questions: [
        {
          id: "py-l3-q1",
          question: "Qual bloco de código garante a execução mesmo se uma exceção for levantada no bloco try?",
          options: ["except", "else", "finally", "catch"],
          correctIndex: 2,
        },
        {
          id: "py-l3-q2",
          question: "Qual palavra-chave é usada para levantar/disparar uma exceção manualmente em Python?",
    ...
    },
    {
      ...
      questions: [
        {
          id: "py-l7-q1",
          question: "Quais métodos especiais um objeto precisa implementar para ser usado como Context Manager (com a palavra-chave with)?",
          options: [
        ...
        {
          id: "py-l7-q3",
          question: "Qual método especial de classe intercepta a criação de instâncias de uma metaclasse?",
    ...
    },
    {
      ...
      questions: [
        {
          id: "py-l8-q1",
          question: "Qual biblioteca padrão gerencia a execução de corrotinas concorrentes assíncronas em Python?",
          options: ["threading", "multiprocessing", "asyncio", "socket"],
          correctIndex: 2,
        },
        {
          id: "py-l8-q2",
          question: "Qual expressão é usada para pausar a execução de uma corrotina aguardando o término de outra corrotina/futuro?",
          options: ["yield from", "await", "wait", "async return"],
          correctIndex: 1,
        },
        {
          id: "py-l8-q3",
          question: "Qual método do asyncio agenda a execução concorrente de múltiplas corrotinas e retorna uma lista ordenada de respostas?",
    ...
    },
    {
      ...
      questions: [
        ...
        {
          id: "py-l9-q2",
          question: "Qual biblioteca padrão do Python deve ser usada para contornar o GIL dividindo tarefas em múltiplos cores de CPU?",
          options: ["threading", "multiprocessing", "subprocess", "asyncio"],
          correctIndex: 1,
        },
        {
          id: "py-l9-q3",
          question: "O que acontece ao tentar usar threads comuns (módulo threading) para acelerar uma tarefa puramente CPU-bound em Python?",
          options: [
  ...
  RUST: [
    {
      ...
      questions: [
        ...
        {
          id: "rust-l1-q3",
          question: "O que acontece ao passar um tipo que não implementa o trait Copy para outra função?",
          options: [
    ...
    },
    {
      ...
      questions: [
        ...
        {
          id: "rust-l2-q2",
          question: "Qual palavra-chave é usada para obter o valor de um Option/Result gerando panic caso seja None/Err?",
      ...
      questions: [
        {
          ...
          options: ["let v = vec![1, 2, 3]", "let v: Array<i32> = [1, 2, 3]", "let v = Vector::new()", "let v = [1, 2, 3]"],
          correctIndex: 0,
        },
        {
          id: "rust-l3-q2",
        ...
        {
          id: "rust-l3-q3",
          question: "Qual é a diferença de uma struct de tupla (Tuple Struct) para uma struct comum?",
          options: [
      ...
      questions: [
        {
          ...
          options: ["impl Trait for Struct", "Struct implements Trait", "Struct : Trait", "use Trait in Struct"],
          correctIndex: 0,
        },
        {
          id: "rust-l4-q2",
          question: "Qual é o equivalente a uma interface em outras linguagens, definindo comportamento compartilhado em Rust?",
          options: ["Struct", "Enum", "Trait", "Module"],
          correctIndex: 2,
        },
        {
          id: "rust-l4-q3",
          question: "Qual parâmetro de método representa a referência imutável à própria instância da struct?",
      ...
      questions: [
        {
          ...
          options: ["fn func<'a>(x: &'a str)", "fn func(x: &a str)", "fn<'a> func(x: &str)", "fn func(x: &str) where 'a"],
          correctIndex: 0,
        },
        {
          id: "rust-l5-q2",
          question: "Qual é o lifetime especial que indica que a referência vive por toda a duração do programa?",
          options: ["'static", "'global", "'always", "'main"],
          correctIndex: 0,
        },
        {
          id: "rust-l5-q3",
          question: "Como impor que um tipo genérico T implemente o trait Display usando a sintaxe trait bounds?",
          options: ["fn show<T: Display>(val: T)", "fn show<T>(val: T) where T: Display", "Ambas as opções A e B estão corretas", "Nenhuma das opções"],
          correctIndex: 2,
        },
      ],
    },
    {
      ...
      questions: [
        ...
        {
          id: "rust-l6-q2",
          question: "Qual método consome um iterador transformando-o em uma coleção concreta (ex: Vec)?",
          options: ["collect()", "to_vec()", "convert()", "drain()"],
          correctIndex: 0,
        },
        {
          id: "rust-l6-q3",
          question: "Qual palavra-chave/modificador força uma closure a capturar o ownership das variáveis externas?",
    ...
    },
    {
      ...
      questions: [
        {
          id: "rust-l7-q1",
          question: "Qual ponteiro inteligente é usado para compartilhar ownership de um recurso entre múltiplas threads de forma segura?",
          options: ["Rc<T>", "Arc<T>", "Box<T>", "RefCell<T>"],
          correctIndex: 1,
        },
        {
          id: "rust-l7-q2",
          question: "Qual smart pointer fornece mutabilidade interna (interior mutability) em tempo de execução sob regras de empréstimo dinâmicas?",
          options: ["Box<T>", "Rc<T>", "RefCell<T>", "Arc<T>"],
          correctIndex: 2,
        },
        {
          id: "rust-l7-q3",
          question: "Qual struct de concorrência garante acesso exclusivo a um dado bloqueando outras threads (exclusão mútua)?",
    ...
    },
    {
      ...
      questions: [
        {
          id: "rust-l9-q1",
          question: "Qual palavra-chave é usada para realizar operações de baixo nível que o compilador não pode garantir a segurança?",
  ...
  GO: [
    ...
    },
    {
      ...
      questions: [
        ...
        {
          id: "go-l2-q3",
          question: "Qual função interrompe o fluxo normal de execução e inicia o desempilhamento de chamadas (unwinding) lançando um erro?",
    ...
    },
    {
      ...
      questions: [
        {
          id: "go-l3-q1",
          question: "Qual caractere é usado para obter o endereço de memória de uma variável em Go?",
          options: ["*", "&", "#", "@"],
          correctIndex: 1,
        },
        {
          id: "go-l3-q2",
          question: "Qual função aloca espaço na memória inicializando-o com o valor zero e retorna um ponteiro para esse endereço?",
          options: ["make()", "new()", "alloc()", "init()"],
          correctIndex: 1,
        },
        {
          id: "go-l3-q3",
          question: "O que acontece ao tentar desreferenciar um ponteiro nulo (nil pointer dereference) em Go?",
          options: [
    ...
    },
    {
      ...
      questions: [
        ...
        {
          id: "go-l5-q3",
          question: "Qual estrutura permite escutar múltiplos canais de comunicação concorrentemente?",
    ...
    },
    {
      ...
      questions: [
        ...
        {
          id: "go-l6-q3",
          question: "Qual arquivo registra as somas de verificação (hashes) exatas das dependências baixadas no Go?",
    ...
    },
    {
      ...
      questions: [
        {
          id: "go-l7-q1",
          question: "Qual struct do pacote sync serve para esperar que um grupo de goroutines termine de rodar?",
          options: ["sync.Mutex", "sync.WaitGroup", "sync.Once", "sync.Cond"],
          correctIndex: 1,
        },
        {
          id: "go-l7-q2",
          question: "O que acontece ao tentar enviar um dado para um canal não bufferizado que não possui um receptor pronto?",
          options: [
        ...
        {
          id: "go-l7-q3",
          question: "Qual função do sync/atomic garante a incrementação thread-safe de inteiros sem mutexes?",
    ...
    },
    {
      ...
      questions: [
        ...
        {
          id: "go-l8-q2",
          question: "Qual função cria um contexto filho que é cancelado automaticamente após um período determinado?",
          options: ["context.WithCancel()", "context.WithTimeout()", "context.WithDeadline()", "Ambas as opções B e C são corretas"],
          correctIndex: 3,
        },
        {
          id: "go-l8-q3",
    ...
    },
    {
      ...
      questions: [
        {
          id: "go-l9-q1",
          question: "Como o Go 1.18+ declara um tipo ou função genérica para aceitar um conjunto específico de tipos?",
          options: [
        ...
        {
          id: "go-l9-q2",
          question: "Qual pacote padrão do Go permite examinar e manipular variáveis de tipos dinâmicos em tempo de execução?",
          options: ["reflect", "inspect", "ast", "runtime"],
          correctIndex: 0,
        },
        {
          id: "go-l9-q3",
          question: "O que o tipo pré-declarado 'comparable' representa como restrição genérica no Go?",
          options: [
...
export function findTrailQuestionById(id: string): { question: TrailQuestion; language: string } | null {
